          ...
          <div className="progress-chart">
            <div className="progress-item">
              <div className="progress-label">
                <span>Body Safety Awareness</span>
            ...
            <div className="progress-item">
              <div className="progress-label">
                ...
                <span className="progress-percentage">{dashboardData.averageScore}%</span>
              </div>
              <div className="progress-bar">
                <div className="progress-fill" style={{width: `${dashboardData.averageScore}%`}}></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="tips-list">
            <div className="tip-item">
              ...
              <p className="tip-text">
                <strong>Encourage Regular Practice:</strong> Short, frequent sessions are more effective than long, infrequent ones.
              </p>
            </div>
            <div className="tip-item">
              <div className="tip-icon">💬</div>
              <p className="tip-text">
                <strong>Discuss What They Learn:</strong> Talk with your child about the lessons to reinforce understanding.
              </p>
            </div>
            <div className="tip-item">
              <div className="tip-icon">🎯</div>
              <p className="tip-text">
                <strong>Set Goals Together:</strong> Create small, achievable goals to keep your child motivated.
              </p>
            </div>
            <div className="tip-item">
              <div className="tip-icon">🌟</div>
              <p className="tip-text">
                <strong>Celebrate Progress:</strong> Acknowledge improvements and achievements, no matter how small.
              </p>
            </div>
          </div>
        </div>
